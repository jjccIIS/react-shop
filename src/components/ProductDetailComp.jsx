        ...
        <div id="ProductDetail"
            ...
            <div>
                <div className="block p-6 rounded-lg shadow-lg bg-white max-w-sm">
                    ...
                    <h5 title={product.name} className="text-[#EB6440] text-xl leading-tight font-medium mb-2">{product.name.length>24?product.name.substring(0, 24)+'...':product.name}</h5>
                    <p className="text-[#497174] text-base mb-4">
                        Some quick example text to build on the card title and make up the bulk of the card's
                        content.
                    </p>
                    <h2 className='text-green-800 font-semibold text-xl'>${product.price}</h2>
                    {isFound ? (
